...
/** Chrome-less 1200×630 stars-over-time render — the /graphs og:image, screenshotted to public/og-graphs.jpg
 * (the og:image for every route — a single SPA index.html serves them all). */
export default function OgGraphs() {
  const { data } = useQuery({
    queryKey: ['targets'],
  ...
  return (
    <div className="og-page" data-ready={ready || undefined}>
      <OgHeader page="graphs" tagline="stars over time — top repos" />
